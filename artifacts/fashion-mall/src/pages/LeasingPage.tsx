    ...
    <MainLayout>
            ...
            {leasingBenefits.map((benefit, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-8 border border-stone-100 hover:border-amber-200 hover:shadow-sm transition-all duration-300 group"
                >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border border-stone-100 p-8 md:p-12">
            <LeasingForm />
          </div>
        </div>
      </section>
