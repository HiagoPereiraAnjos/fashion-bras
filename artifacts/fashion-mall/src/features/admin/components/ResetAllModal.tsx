      ...
      {open && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1 }}
            exit={{ scale: 0.95 }}
            className="bg-white px-4 py-5 sm:p-8 max-w-sm w-full"
          >
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
              <button
                onClick={onCancel}
                className="w-full sm:flex-1 h-10 border border-stone-200 text-xs uppercase tracking-wider text-stone-600 hover:border-stone-400 disabled:opacity-50"
              ...
              <button
                onClick={onConfirm}
                className="w-full sm:flex-1 h-10 bg-red-600 text-white text-xs uppercase tracking-wider hover:bg-red-700 disabled:opacity-70 disabled:cursor-wait"
                disabled={isProcessing}
              >
